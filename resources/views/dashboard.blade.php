...
<html lang="en" data-bs-theme="auto">
  ...
  <link rel="icon" href="{{ asset('images/icons/favicon-16x16.png') }}" sizes="16x16" type="image/png">
  <link rel="manifest" href="{{ asset('images/icons/manifest.json') }}">
  <link rel="mask-icon" href="{{ asset('images/icons/safari-pinned-tab.svg') }}" color="#712cf9">
